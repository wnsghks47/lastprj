...
<div class="container-fluid bg-white">
	<div class="row justify-content-center" style="height: 150px;">
		<div class="col-10 d-flex align-items-end border-bottom border-dark">
			<h1 class="mb-4" style="letter-spacing: 10px; font-size: calc(30px + 0.5vw);">이벤트 수정</h1>
		</div>
	</div>
</div>
<div class="container-fluid bg-white">
	<div class="row justify-content-center">
		<div class="col-10 py-5">
			<form action="updateEvent" method="post" autocomplete="off">
				...
				<div class="form-group mb-5">
					<div class="float-right">
						<input type="hidden" name="enumber" id="enumber" type="text"/>
	...
	$(document).ready(function() {
		...
		$.ajax({
	        ...
	        success: function(data) {
	        	...
	        	$('input#title').val(data.etitle);
	    		$('#summernote').summernote('code', data.eventimg);				
	    		$('input#enumber').val(data.enumber);
	    		$('input#startdate').val(data.estartdate);
	    		$('input#enddate').val(data.eenddate);
