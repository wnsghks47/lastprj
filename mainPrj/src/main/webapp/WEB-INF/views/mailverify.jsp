			...
			<div class="row justify-content-center">
				<div class="col-md-4 mt-3">
					<div class="login-box1">
						<h2>
							<strong style="font-size: calc(15px + 0.75vw);">이메일 인증</strong>
						</h2>
						<form action="verifycheck" method="post">
							<div class="user-box1">
								<input type="text" name="verify" required> <label>인증받을 메일</label>
							</div>
							<div class="d-flex justify-content-end">
								<input type="submit" id="submit" class="btn btn-link mt-4" value="인증번호보내기">
							</div>
						</form>
					</div>
				</div>
