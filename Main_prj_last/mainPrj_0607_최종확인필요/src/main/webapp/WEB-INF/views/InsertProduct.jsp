...
<div class="container-fluid bg-white">
	<div class="row justify-content-center" style="height: 150px;">
		<div class="col-10 d-flex align-items-end border-bottom border-dark">
			<h1 class="mb-4" style="letter-spacing: 10px; font-size: calc(30px + 0.5vw);">제품 데이터 등록</h1>
		</div>
	</div>
</div>
<div class="container-fluid bg-white">
	<div class="row justify-content-center">
		<div class="col-10 py-5">
			<form action="insertProductData" method="post" autocomplete="off">
				...
				<div class="form-group mb-5">
					<label for="category"><span class="h4" style="font-size: calc(15px + 0.2vw);">카테고리</span></label> 
					<input type="text" class="form-control" id="category" name="category" placeholder="제품의 카테고리를 넣어주세요." required>
				</div>
				<div class="form-group mb-5">
				<div class="row">
					<div class="col-6">
				...
				<div class="form-group mb-5">
					...
					<textarea class="form-control" id="content" rows="3" name="content" placeholder="제품의 상세 설명을 입력해주세요."></textarea>
				</div>
				<div class="form-group mb-5">
				...
				<div class="form-group mb-5">
					<label for="ingredient"><span class="h4" style="font-size: calc(15px + 0.2vw);">성분</span></label> 
					<textarea class="form-control" name="ingredient" id="ingredient" rows="3" placeholder="성분을 ' , ' 로 구분하여 입력해주세요."></textarea>
				</div>
				<div class="form-group mb-5">
