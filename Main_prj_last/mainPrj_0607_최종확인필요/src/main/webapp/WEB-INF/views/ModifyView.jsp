...
<div class="container-fluid bg-white">
	<div class="row justify-content-center" style="height: 150px;">
		<div class="col-10 d-flex align-items-end border-bottom border-dark">
			<h1 class="mb-4" style="letter-spacing: 10px;">리뷰수정</h1>
		</div>
	</div>
</div>
<div class="container-fluid bg-white">
	...
	$(document).ready(function() {
		...
		$.ajax({
	        ...
	        success: function(data) {
				...
				$('input#title').val(data.detail.rtitle);
				$('#summernote').summernote('code', data.detail.rcontent);				
				$('input#rnumber').val(data.detail.rnumber);
				$('input#rdate').val(data.detail.rdate);
